export OPENAI_LOGDIR=/scratch/mb26/tv8394/workspace/improved-diffusion/simple-shapes-5k-checkpoints
rm -rf $OPENAI_LOGDIR
MODEL_FLAGS="--image_size 64 --num_channels 128 --num_res_blocks 3"
DIFFUSION_FLAGS="--diffusion_steps 4000 --noise_schedule linear"
TRAIN_FLAGS="--lr 1e-4 --batch_size 16 --lr_anneal_steps 700000"
